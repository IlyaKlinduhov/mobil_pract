package ru.mirea.klinduhovir.osmmaps;
...
import ru.mirea.klinduhovir.osmmaps.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Mirea strominka", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker1.setPosition(new GeoPoint(55.731582, 37.574840));
        marker1.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Mirea Frunza", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Mirea main", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker3.setPosition(new GeoPoint(55.661963, 37.476537));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Mirea no name", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
