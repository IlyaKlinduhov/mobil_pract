package ru.mirea.klinduhovir.yandexdriver;
...
import ru.mirea.klinduhovir.yandexdriver.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.addTapListener(new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(), "Общежитие 2",
    ...
    public void onObjectAdded(@NonNull UserLocationView userLocationView) {
        ...
        mapKit.createLocationManager().requestSingleUpdate(new LocationListener() {
            ...
            public void onLocationUpdated(@NonNull Location location) {
                ...
                submitRequest(location.getPosition(), new Point(55.704205, 37.507699));
            }
