...
import ru.mirea.klinduhovir.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onClickButton(View view) {
        ...
        byte[] encrypted_text = encryptMsg(binding.editText.getText().toString(), key);
        bundle.putByteArray(MyLoader.ARG_KEY, key.getEncoded());
        bundle.putByteArray(MyLoader.ARG_TEXT, encrypted_text);
